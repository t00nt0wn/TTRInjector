...
webbrowser.cache("www.google.com") #add google to the webbrowser module cache list....
...
datagram.sendPOSTREQ("gameserver.toontownrewritten.com") #send it to ttrs gameserver
